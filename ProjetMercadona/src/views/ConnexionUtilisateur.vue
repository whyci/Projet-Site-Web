<template>
  <div class="p-10">
    ...
    <h1 class="text-4xl font-bold text-green-900">Se connecter utilisateur</h1>
    <br>
...
<br>
  ...
  <div class="text-center p-2">
    <br>
    <!-- le router-link permet de faire le lien avec la page de création de création utilisateur -->
    <router-link
      :to="{ name: 'creationUtilisateur' }"
    >
      <!-- ici on crée le bouton et défini son style - et lorsque l'on clique sur le bouton ça nous amène sur la page de création utilisateur -->
      <button style="border: 1px; padding : 12px; background-color : lightgray; color :black"
              @click="navigate"
              role="link"
      >
